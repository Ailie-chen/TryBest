...
namespace knob
{
    ...
    // specific knobs
    vector<int32_t> ocp_perc_activated_features = {5, 8, 9, 11, 16};
    vector<int32_t> ocp_perc_weight_array_sizes = {1024, 1024, 128, 1024, 1024};
    vector<int32_t> ocp_perc_feature_hash_types = {2, 2, 2, 2, 2};
    float ocp_perc_activation_threshold = -17.0f;
    float ocp_perc_max_weight = 15.0f;
    float ocp_perc_min_weight = -16.0f;
    float ocp_perc_pos_weight_delta = 1.0f;
    float ocp_perc_neg_weight_delta = 1.0f;
    float ocp_perc_pos_train_thresh = 40.0f;
    float ocp_perc_neg_train_thresh = -35.0f;
    uint32_t ocp_perc_page_buf_sets = 64;
    uint32_t ocp_perc_page_buf_assoc = 16;
    uint32_t ocp_perc_last_n_load_pcs = 4;
    uint32_t ocp_perc_last_n_pcs = 4;
    bool ocp_perc_enable_dynamic_act_thresh = false;
    uint32_t ocp_perc_update_act_thresh_epoch = 10; // Default value
    uint32_t ocp_perc_high_critical_dram_bw_level = 90;
    uint32_t ocp_perc_low_critical_dram_bw_level = 30;
    float ocp_perc_poor_precision_thresh = 0.05f;
    float ocp_perc_act_thresh_update_gradient = 0.1f;
    float ocp_perc_min_activation_threshold = -20.0f; // Adjusted range
    float ocp_perc_max_activation_threshold = 20.0f;  // Adjusted range
}
