...
int8_t PACKET_QUEUE_BASE::get_module_type()
{
    ...
    else if (NAME.find("EMPTY") != string::npos)     return IS_DRAM;
    else if (NAME.find("PSCL5") != string::npos)    return IS_PSCL5;
    else if (NAME.find("PSCL4") != string::npos)    return IS_PSCL4;
    else if (NAME.find("PSCL3") != string::npos)    return IS_PSCL3;
    else if (NAME.find("PSCL2") != string::npos)    return IS_PSCL2;
    return IS_DRAM_CONTROLLER_QUEUE;
...
int8_t PACKET_QUEUE_BASE::get_queue_type()
{
    ...
    else if (NAME.find("EMPTY") != string::npos)         return IS_DRAM_QUEUE;
